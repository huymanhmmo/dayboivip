export const locations = [
  {
    ...
    pools: [
      ...
      { name: "Bể bơi Bảo Sơn", address: "50 Nguyễn Chí Thanh, Láng Thượng, Đống Đa, Hà Nội", type: "Trong nhà nước ấm", pros: "Nước ấm quanh năm, sạch sẽ, riêng tư." },
      { name: "Bể bơi Hapulico", address: "83 Vũ Trọng Phụng, Thanh Xuân, Hà Nội", type: "Trong nhà nước mặn", pros: "Bể bơi nước mặn cao cấp, hiện đại, thích hợp học cả mùa đông." },
      { name: "Bể bơi Vinhomes Times City", address: "458 Minh Khai, Hai Bà Trưng, Hà Nội", type: "Trong nhà", pros: "Bể bơi nội khu cao cấp cho cư dân và học viên Swim For Life." }
    ],
    faqs: [
      { q: "Swim For Life dạy bơi ở những bể bơi nào tại Hà Nội?", a: "Chúng tôi dạy tại nhiều bể bơi chất lượng cao như: Tăng Bạt Hổ, Bách Khoa, Times City, Bảo Sơn, Hapulico và các bể bơi khu đô thị Vinhomes Ocean Park, Smart City." },
      { q: "Học bơi ở Hà Nội giá bao nhiêu?", a: "Chi phí tùy thuộc vào hình thức học (1 kèm 1 hoặc nhóm nhỏ) và địa điểm bể bơi. Tất cả mức giá đều được tối ưu và hỗ trợ học thử miễn phí. Vui lòng liên hệ hotline 0979.121.097 để nhận báo giá chi tiết." },
      { q: "Học bơi ở Hà Nội mùa đông có được không?", a: "Hoàn toàn được! Chúng tôi có hệ thống bể bơi bốn mùa nước ấm trong nhà như Hapulico, Bảo Sơn, Times City giúp duy trì việc học bơi suốt mùa đông ấm áp." }
    ]
  },
  {
    slug: "hoc-boi-tphcm",
    ...
    faqs: [
      ...
      { q: "Thời gian học bơi ở Sài Gòn thế nào?", a: "Vì thời tiết Sài Gòn nắng ấm quanh năm, bạn có thể đăng ký học bất kỳ thời gian nào từ 6:00 sáng đến 21:00 tối các ngày trong tuần." }
    ]
  },
  {
    slug: "hoc-boi-da-nang",
    name: "Đà Nẵng",
    region: "Miền Trung",
    isTW: true,
    color: "teal",
    ...
    intro: "Thành phố Đà Nẵng (bao gồm khu vực Quảng Nam cũ) là đô thị biển năng động. Việc trang bị kỹ năng bơi lội và đứng nước sinh tồn tại đây là vô cùng quan trọng đối với trẻ em để tự tin vui chơi dưới nước.",
    pools: [
      { name: "Bể bơi Quân Khu 5", address: "7 Duy Tân, Hải Châu, Đà Nẵng", type: "Ngoài trời", pros: "Bể bơi tiêu chuẩn quân đội, rộng rãi, nước sạch." },
  ...
  {
    slug: "hoc-boi-hai-phong",
    name: "Hải Phòng",
    region: "Miền Bắc",
    isTW: true,
    color: "aqua",
    mergedFrom: "Hải Dương + Hải Phòng",
    ...
    pools: [
      { name: "Bể bơi Hồ Sen", address: "Số 10 Hồ Sen, Lê Chân, Hải Phòng", type: "Ngoài trời", pros: "Vị trí trung tâm thuận tiện, nước sạch lọc tuần hoàn liên tục." },
  ...
  },
  {
    ...
    color: "teal",
    mergedFrom: "",
    title: "Học Bơi Huế: Lớp Dạy Bơi Uy Tín Tại Thành Phố Huế",
    description: "Đăng ký học bơi tại Huế cùng các HLV chuyên nghiệp của Swim For Life Việt Nam. Khóa học bơi trẻ em, người lớn 1 kèm 1 cam kết biết bơi tốt.",
    headline: "Học Bơi Huế: Khóa Học Bơi Uy Tín & An Toàn Bậc Nhất",
    subtitle: "Lớp học bơi chất lượng cao tại cố đô Huế. Dạy bơi 1 kèm 1, cam kết biết bơi, học thử hoàn toàn miễn phí.",
  ...
  {
    slug: "hoc-boi-can-tho",
    name: "Cần Thơ",
    region: "Miền Tây Nam Bộ",
    isTW: true,
    color: "coral",
    mergedFrom: "Cần Thơ + Sóc Trăng + Hậu Giang",
    title: "Học Bơi Cần Thơ - Sóc Trăng - Hậu Giang: Lớp Bơi 1 Kèm 1 Uy Tín",
    description: "Khóa học bơi Cần Thơ, Sóc Trăng và Hậu Giang cùng trung tâm Swim For Life. Dạy bơi 1 kèm 1 an toàn chuyên nghiệp, cam kết bơi tốt đứng nước vững vàng.",
    headline: "Học Bơi Cần Thơ - Sóc Trăng - Hậu Giang: Dạy Bơi Chất Lượng Cao",
    subtitle: "Học bơi an toàn vùng sông nước miền Tây. Lớp dạy bơi 1 kèm 1 uy tín, cam kết biết bơi 100%.",
    image: "/images/classes/lop-hoc-boi-tre-em-tphcm.jpg",
  ...
  {
    slug: "hoc-boi-dong-nai",
    name: "Đồng Nai",
    region: "Tây Nguyên & Đông Nam Bộ",
    isTW: true,
    color: "gold",
    mergedFrom: "Đồng Nai + Bình Phước",
    title: "Học Bơi Đồng Nai - Bình Phước: Lớp Học Bơi 1 Kèm 1 Chất Lượng",
    description: "Tuyển sinh lớp học bơi Đồng Nai và Bình Phước uy tín cùng Swim For Life Việt Nam. Dạy bơi 1 kèm 1 cho trẻ em & người lớn nhát nước, cam kết biết bơi.",
    headline: "Học Bơi Đồng Nai - Bình Phước: Lớp Học Bơi 1 Kèm 1 Uy Tín",
    subtitle: "Dạy bơi uy tín tại Biên Hòa, Long Khánh, Đồng Nai và tỉnh Bình Phước. HLV chuyên nghiệp, giờ học linh hoạt.",
  ...
  {
    slug: "hoc-boi-thai-nguyen",
    name: "Thái Nguyên",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "Bắc Kạn + Thái Nguyên",
    title: "Học Bơi Thái Nguyên - Bắc Kạn: Lớp Dạy Bơi Uy Tín Cam Kết Biết Bơi",
    description: "Khóa học bơi tại Thái Nguyên và Bắc Kạn dành cho mọi đối tượng. Học bơi 1 kèm 1 an toàn hiệu quả cùng HLV Swim For Life. Đăng ký ngay hôm nay.",
    headline: "Học Bơi Thái Nguyên - Bắc Kạn: Giáo Trình Bơi Sư Phạm Chuẩn",
    subtitle: "Đào tạo bơi lội an toàn tại Thái Nguyên và Bắc Kạn. Cam kết biết bơi sau 12 buổi, hỗ trợ học thử miễn phí.",
    image: "/images/classes/lop-hoc-boi-vui-ve-ky-luat.jpg",
  ...
  {
    slug: "hoc-boi-ninh-binh",
    name: "Ninh Bình",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "Hà Nam + Nam Định + Ninh Bình",
    title: "Học Bơi Ninh Bình - Nam Định - Hà Nam: Khóa Học Bơi Sư Phạm Chuẩn",
    description: "Tuyển sinh lớp học bơi tại Ninh Bình, Nam Định, Hà Nam. Dạy bơi 1 kèm 1 uy tín chuyên nghiệp, cam kết bơi tốt đứng nước vững vàng.",
    headline: "Học Bơi Ninh Bình - Nam Định - Hà Nam: Học Bơi Sinh Tồn Chuẩn",
    subtitle: "Đào tạo bơi lội an toàn vùng Nam Đồng Bằng Sông Hồng. HLV giàu kinh nghiệm, cam kết biết bơi tốt.",
  ...
  {
    slug: "hoc-boi-thanh-hoa",
    name: "Thanh Hóa",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "",
    title: "Học Bơi Thanh Hóa: Lớp Dạy Bơi Uy Tín Chất Lượng Nhất",
    description: "Tuyển sinh lớp học bơi tại Thanh Hóa cùng HLV chuyên nghiệp của Swim For Life. Học bơi 1 kèm 1 cho trẻ em & người lớn nhát nước, cam kết biết bơi.",
    headline: "Học Bơi Thanh Hóa: Lớp Học Bơi Uy Tín & Bài Bản",
    subtitle: "Đào tạo bơi lội an toàn tại TP. Thanh Hóa, Sầm Sơn, Bỉm Sơn. Cam kết bơi tốt đứng nước tự tin.",
    image: "/images/classes/lop-hoc-boi-vui-ve-ky-luat.jpg",
  ...
  {
    slug: "hoc-boi-quang-binh",
    name: "Quảng Bình",
    region: "Miền Trung",
    isTW: false,
    color: "teal",
    mergedFrom: "Quảng Bình + Quảng Trị",
    title: "Học Bơi Quảng Bình - Quảng Trị: Khóa Học Bơi Uy Tín Bậc Nhất",
    description: "Khóa học bơi tại Quảng Bình và Quảng Trị uy tín từ Swim For Life. Dạy bơi 1 kèm 1 chất lượng cao, cam kết biết bơi tốt tự tin đứng nước.",
    headline: "Học Bơi Quảng Bình - Quảng Trị: Khóa Dạy Bơi Chuyên Nghiệp",
    subtitle: "Dạy bơi tại Đồng Hới (Quảng Bình) và Đông Hà (Quảng Trị). Cam kết bơi thành thạo, HLV tâm lý nhiệt tình.",
    image: "/images/classes/lop-hoc-boi-tre-em-tphcm.jpg",
  ...
  {
    slug: "hoc-boi-khanh-hoa",
    name: "Khánh Hòa",
    region: "Miền Trung",
    isTW: false,
    color: "teal",
    mergedFrom: "Khánh Hòa + Ninh Thuận + Bình Thuận",
    title: "Học Bơi Khánh Hòa - Ninh Thuận - Bình Thuận: Khóa Học Bơi Uy Tín",
    description: "Lớp học bơi tại Nha Trang (Khánh Hòa), Phan Rang (Ninh Thuận), Phan Thiết (Bình Thuận). Dạy bơi 1 kèm 1 cam kết bơi tốt đứng nước tự tin.",
    headline: "Học Bơi Khánh Hòa - Ninh Thuận - Bình Thuận: Dạy Bơi Sư Phạm",
    subtitle: "Dạy bơi uy tín tại Nha Trang, Phan Thiết, Phan Rang. HLV chuyên môn cao, cam kết biết bơi.",
    image: "/images/classes/lop-hoc-boi-vui-ve-ky-luat.jpg",
  ...
  {
    slug: "hoc-boi-dak-lak",
    name: "Đắk Lắk",
    region: "Tây Nguyên & Đông Nam Bộ",
    isTW: false,
    color: "gold",
    mergedFrom: "Đắk Lắk + Đắk Nông + Kon Tum",
    title: "Học Bơi Đắk Lắk - Đắk Nông - Kon Tum: Lớp Học Bơi Tây Nguyên Uy Tín",
    description: "Lớp học bơi tại Buôn Ma Thuột (Đắk Lắk), Gia Nghĩa (Đắk Nông), Kon Tum cùng Swim For Life. Dạy bơi 1 kèm 1 uy tín chuyên nghiệp, cam kết bơi tốt.",
    headline: "Học Bơi Đắk Lắk - Đắk Nông - Kon Tum: Lớp Học Bơi Chất Lượng",
    subtitle: "Lớp dạy bơi uy tín vùng cao nguyên đất đỏ Tây Nguyên. Cam kết biết bơi, học thử miễn phí.",
    image: "/images/classes/to-chuc-tap-luyen-bai-ban-chuyen-nghiep.jpg",
  ...
  {
    slug: "hoc-boi-lam-dong",
    name: "Lâm Đồng",
    region: "Tây Nguyên & Đông Nam Bộ",
    isTW: false,
    color: "gold",
    mergedFrom: "",
    title: "Học Bơi Lâm Đồng: Lớp Dạy Bơi Đà Lạt Uy Tín Hàng Đầu",
    description: "Đăng ký học bơi tại Lâm Đồng (Đà Lạt, Bảo Lộc) cùng HLV chuyên nghiệp của Swim For Life Việt Nam. Dạy bơi 1 kèm 1, cam kết biết bơi 100%.",
    headline: "Học Bơi Lâm Đồng: Khóa Học Bơi Đà Lạt - Bảo Lộc Uy Tín",
    subtitle: "Dạy bơi chất lượng tại thành phố hoa Đà Lạt và Bảo Lộc. Cam kết biết bơi an toàn.",
    image: "/images/classes/giang-vien-huong-dan-ky-thuat.jpg",
  ...
  },
  {
    ...
    image: "/images/classes/lop-hoc-boi-ha-noi.jpg",
    intro: "Tây Ninh và Long An là cửa ngõ giao thương vùng Đông và Tây Nam Bộ. Các lớp dạy bơi chất lượng giúp trẻ nâng cao thể lực và an toàn vùng sông nước.",
    pools: [
      { name: "Hồ bơi Bốn Mùa Meliá Vinpearl Tây Ninh", address: "Số 90 đường Lê Duẩn, Phường 3, TP. Tây Ninh", type: "Trong nhà nước ấm 5 sao", pros: "Bể bơi bốn mùa nước ấm trong nhà duy nhất tại Tây Ninh, tầm nhìn panorama ngắm núi Bà Đen và toàn cảnh thành phố." },
      { name: "Hồ bơi CANA Tây Ninh", address: "Số 22 Lý Thường Kiệt, TX. Hòa Thành, Tây Ninh", type: "Thương mại công nghệ Pháp", pros: "Hồ bơi hiện đại ứng dụng công nghệ lọc cát tuần hoàn nhập khẩu từ Pháp, nước trong veo không hóa chất độc hại." },
      { name: "Hồ bơi 175 (Hồ bơi Tỉnh đội Long An)", address: "Số 175 Quốc lộ 62, Phường 6, TP. Tân An, Long An", type: "Chuẩn thi đấu có mái che", pros: "Hệ thống mái che toàn phần kiên cố tránh nắng mưa tuyệt đối, đạt chuẩn thi đấu thể thao, cứu hộ quân sự túc trực an toàn." },
      { name: "Hồ bơi TT Sinh Hoạt Thanh Thiếu Nhi Tây Ninh", address: "Đường 30 Tháng 4, Phường 3, TP. Tây Ninh", type: "Thiếu nhi có mái che lưới", pros: "Cơ sở công lập đào tạo bơi lội uy tín, phân khu mực nước an toàn cho trẻ nhỏ, HLV sư phạm giàu kinh nghiệm." }
    ],
    faqs: [
  ...
  {
    slug: "hoc-boi-dong-thap",
    name: "Đồng Tháp",
    region: "Miền Tây Nam Bộ",
    isTW: false,
    color: "coral",
    mergedFrom: "Tiền Giang + Đồng Tháp",
    title: "Học Bơi Đồng Tháp - Tiền Giang: Lớp Học Bơi Sư Phạm Uy Tín",
    description: "Đăng ký lớp học bơi tại Đồng Tháp (Cao Lãnh) và Tiền Giang (Mỹ Tho). Dạy bơi 1 kèm 1 cam kết bơi tốt đứng nước sâu tự tin.",
    headline: "Học Bơi Đồng Tháp - Tiền Giang: Dạy Bơi Sinh Tồn Vùng Lũ",
    subtitle: "Dạy bơi uy tín tại Cao Lãnh, Sa Đéc (Đồng Tháp) và Mỹ Tho (Tiền Giang). HLV tận tâm sư phạm tốt.",
    image: "/images/classes/lop-hoc-boi-tre-em-tphcm.jpg",
    ...
    faqs: [
      { q: "Tại TP. Cao Lãnh địa điểm học bơi nào uy tín và an toàn nhất cho trẻ em?", a: "Hồ bơi Trung tâm Hoạt động Thanh Thiếu Nhi Đồng Tháp (38 Điện Biên Phủ) là địa chỉ đào tạo bơi lội trẻ em số 1 tỉnh với phân khu mực nước nông an toàn và HLV sư phạm theo sát." },
      { q: "Ở TP. Mỹ Tho (Tiền Giang) phụ huynh nên đăng ký học bơi ở đâu?", a: "Tại TP. Mỹ Tho, cơ sở khang trang nhất là Hồ bơi Tỉnh Tiền Giang (số 1 Phan Lương Trực) và Hồ bơi Thành phố Mỹ Tho (đường Tết Mậu Thân) với các lớp dạy kèm riêng chất lượng cao của Swim For Life." },
      { q: "Vì sao trẻ em vùng rốn lũ Đồng Tháp và Tiền Giang cần học bơi sinh tồn từ sớm?", a: "Do đặc thù sông ngòi dày đặc và mùa nước nổi hàng năm, biết bơi và đứng nước giúp các em tự cứu bản thân khi trượt chân xuống kênh rạch, tránh rủi ro tai nạn đuối nước thương tâm." },
      { q: "Học phí khóa dạy bơi 1 kèm 1 tại Cao Lãnh và Mỹ Tho khoảng bao nhiêu?", a: "Học phí khóa kèm riêng 1-1 dao động 2.500.000đ - 3.000.000đ/khóa 10-12 buổi (chưa bao gồm vé bể bơi). Cam kết đầu ra biết bơi chuẩn kỹ thuật và đứng nước vững vàng." }
    ]
  },
  {
    slug: "hoc-boi-vinh-long",
    name: "Vĩnh Long",
    region: "Miền Tây Nam Bộ",
    isTW: false,
    color: "coral",
    ...
    faqs: [
      { q: "Bể bơi nào ở TP. Vĩnh Long có mái che giúp học bơi không sợ nắng gắt?", a: "Hồ bơi Minh Anh (3Y đường Nguyễn Văn Đáng, Phường 8) có hệ thống mái che kiên cố toàn phần, giúp học viên tập bơi thoải mái suốt ngày mà không lo nắng nóng." },
      { q: "Tại Bến Tre có hồ bơi muối khoáng nào an toàn cho da và mắt trẻ nhỏ không?", a: "Tại TP. Bến Tre có Hồ bơi Muối Khoáng LPHOME (910/1 Võ Nguyên Giáp, xã Sơn Đông) ứng dụng điện phân muối khoáng tự nhiên, nước trong lành không mùi hóa chất độc hại." },
      { q: "Ở TP. Trà Vinh địa chỉ học bơi nào rộng rãi và sạch đẹp nhất?", a: "Địa chỉ nổi bật nhất tại TP. Trà Vinh là Hồ bơi Khu Du Lịch Sinh Thái Huỳnh Kha (đường Chu Văn An, Phường 4) và Hồ bơi Nhà Thi Đấu Trà Vinh (khu di tích Ao Bà Om)." },
      { q: "Lớp bơi vùng cù lao sông nước có dạy kỹ năng đứng nước và cứu đuối không?", a: "Có. Ngoài kỹ thuật bơi ếch và bơi sải, giáo trình đặc biệt chú trọng dạy kỹ năng đứng nước sinh tồn tại chỗ, kỹ năng thả nổi ngửa giữ sức và cách ném phao cứu người đuối nước." }
    ]
  },
  {
    slug: "hoc-boi-an-giang",
    name: "An Giang",
    region: "Miền Tây Nam Bộ",
    isTW: false,
    color: "coral",
    mergedFrom: "Kiên Giang + An Giang",
    title: "Học Bơi An Giang - Kiên Giang: Lớp Học Bơi 1 Kèm 1 Đầy Chất Lượng",
    description: "Đăng ký khóa học bơi tại An Giang (Long Xuyên) và Kiên Giang (Rạch Giá). Dạy bơi 1 kèm 1 an toàn chuyên nghiệp, cam kết bơi tốt đứng vững.",
    headline: "Học Bơi An Giang - Kiên Giang: Lớp Dạy Bơi Uy Tín Hàng Đầu",
    subtitle: "Dạy bơi uy tín chất lượng vùng Tứ Giác Long Xuyên. HLV chuyên nghiệp, cam kết biết bơi.",
    image: "/images/classes/lop-boi-tran-ngap-tieng-cuoi.jpg",
    intro: "An Giang và Kiên Giang có nhu cầu phát triển thể chất và kỹ năng bơi lội cho con trẻ rất lớn. Lớp bơi Swim For Life đem lại môi trường rèn luyện vui vẻ dẻo dai khỏe mạnh.",
    pools: [
      { name: "Hồ bơi Phú Cường Park Rạch Giá", address: "Số 01 Nguyễn Thanh Nhàn, KĐT Phú Cường, P. An Hòa, TP. Rạch Giá, Kiên Giang", type: "Resort KĐT lấn biển cao cấp", pros: "Hồ bơi hiện đại bậc nhất Kiên Giang trong KĐT lấn biển, làn nước trong veo, công nghệ lọc tuần hoàn thông minh chuẩn quốc tế." },
      { name: "Hồ bơi Thành phố Long Xuyên", address: "Đường Âu Cơ, P. Bình Khánh, TP. Long Xuyên, An Giang", type: "Hồ bơi thể thao công lập", pros: "Diện tích rộng rãi gồm hồ lớn nhiều làn bơi thể thao và hồ vầy thiếu nhi an toàn, đội ngũ cứu hộ giám sát chặt chẽ." },
      { name: "Hồ bơi Yết Kiêu Long Xuyên", address: "Số 88 đường Nguyễn Xí, P. Mỹ Bình, TP. Long Xuyên, An Giang", type: "CLB bơi phong trào lâu năm", pros: "CLB bơi lội uy tín lâu năm của TP. Long Xuyên, chất lượng nước kiểm soát nghiêm ngặt, HLV nhiệt tình sửa dáng chuẩn." },
  ...
  },
  {
    ...
    image: "/images/classes/lop-hoc-boi-vui-ve-ky-luat.jpg",
    intro: "Cà Mau và Bạc Liêu là vùng đất ngập mặn cuối trời Nam Tổ Quốc. Biết bơi giúp người dân và trẻ em tự bảo vệ mình trong các hoạt động sông nước sinh hoạt hàng ngày.",
    pools: [
      { name: "Hồ bơi Khách Sạn Mường Thanh Luxury Cà Mau", address: "Đường Phan Ngọc Hiển, Phường 9, TP. Cà Mau", type: "Ngoài trời chuẩn 5 sao", pros: "Hồ bơi ngoài trời sang trọng bậc nhất Cà Mau, làn nước trong vắt, lọc tuần hoàn cao cấp không mùi hóa chất, an ninh tuyệt đối." },
      { name: "Hồ bơi Thanh Thế – Nhà Thiếu Nhi Cà Mau", address: "Đường Lê Duẩn, Phường 1, TP. Cà Mau", type: "Thiếu nhi có mái che lưới", pros: "Địa chỉ dạy bơi truyền thống gắn bó với thiếu nhi đất mũi, giá vé bình dân, chuyên đào tạo bơi phổ cập chống đuối nước." },
      { name: "Hồ bơi TANK CLUB Sóc Trăng", address: "Đường Nguyễn Chí Thanh, Phường 6, TP. Sóc Trăng", type: "Tổ hợp thể thao hiện đại", pros: "Tổ hợp thể thao tích hợp hồ bơi và cầu lông hiện đại, nước trong veo không nồng clo, không gian sạch sẽ thoáng mát." },
      { name: "Hồ bơi Khách Sạn Công Tử Bạc Liêu", address: "Số 13 đường Điện Biên Phủ, Phường 3, TP. Bạc Liêu", type: "Hồ vô cực tầng 5 view sông", pros: "Hồ bơi vô cực tọa lạc tại tầng 5 ngắm toàn cảnh sông Bạc Liêu thơ mộng, không gian thư giãn sang trọng chuẩn mực." }
    ],
    faqs: [
      { q: "Tại TP. Cà Mau phụ huynh nên chọn hồ bơi nào để con học bơi kèm riêng tốt nhất?", a: "Phụ huynh nên chọn Hồ bơi Mường Thanh Luxury Cà Mau (đường Phan Ngọc Hiển) để được hưởng không gian 5 sao sạch đẹp và an toàn, hoặc chọn Hồ bơi Nhà Thiếu Nhi Cà Mau (đường Lê Duẩn) với mức chi phí rất bình dân." },
      { q: "Ở Bạc Liêu và Sóc Trăng có địa chỉ học bơi nào sạch sẽ và huấn luyện bài bản?", a: "Tại TP. Bạc Liêu có Hồ bơi Trường ĐH Bạc Liêu và KS Công Tử Bạc Liêu; tại TP. Sóc Trăng có Hồ bơi TANK CLUB (Nguyễn Chí Thanh) và Hồ bơi Nhà thiếu nhi tỉnh Sóc Trăng (12 Hùng Vương)." },
      { q: "Vùng sông nước ngập mặn Cà Mau trẻ em mấy tuổi nên bắt đầu học bơi sinh tồn?", a: "Trẻ em từ 4.5 đến 5 tuổi đã có thể bắt đầu tham gia các khóa học bơi sinh tồn làm quen nước, tập phản xạ ngửa mặt lấy hơi và nổi bồng bềnh để tự bảo vệ bản thân." },
      { q: "Khóa học bơi 1 kèm 1 tại Cà Mau có bảo hành kết quả học tập không?", a: "Swim For Life bảo hành kết quả trọn đời cho học viên: 100% học viên bơi thành thạo cự ly tối thiểu 50m và đứng nước sâu tự tin mới kết thúc khóa học." }
    ]
  },
  {
    slug: "hoc-boi-cao-bang",
    name: "Cao Bằng",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "",
    title: "Học Bơi Cao Bằng: Lớp Học Bơi Cho Trẻ Em & Người Lớn Uy Tín",
    description: "Đăng ký khóa học bơi Cao Bằng tại Swim For Life Việt Nam. Dạy bơi 1 kèm 1 cam kết bơi tốt đứng nước tự tin, HLV giàu nghiệp vụ sư phạm.",
  ...
  {
    slug: "hoc-boi-lai-chau",
    name: "Lai Châu",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "",
    title: "Học Bơi Lai Châu: Lớp Học Bơi 1 Kèm 1 Uy Tín Tại Lai Châu",
    description: "Đăng ký lớp dạy bơi Lai Châu uy tín cùng Swim For Life. HLV kèm riêng 1 kèm 1 cam kết biết bơi tốt đứng nước vững vàng an toàn.",
  ...
  },
  {
    ...
    color: "aqua",
    mergedFrom: "",
    title: "Học Bơi Sơn La: Lớp Dạy Bơi Uy Tín Tại Thành Phố Sơn La",
    description: "Khóa học bơi tại Sơn La uy tín chất lượng cao. Học bơi 1 kèm 1 cam kết bơi tốt đứng nước vững vàng cùng HLV Swim For Life Việt Nam.",
  ...
  {
    slug: "hoc-boi-lang-son",
    name: "Lạng Sơn",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "",
    title: "Học Bơi Lạng Sơn: Lớp Học Bơi Uy Tín Chất Lượng Nhất Lạng Sơn",
    description: "Tuyển sinh lớp học bơi tại Lạng Sơn. Dạy bơi 1 kèm 1 cam kết biết bơi tốt đứng nước sâu tự tin cùng giáo viên chuyên nghiệp Swim For Life.",
  ...
  {
    slug: "hoc-boi-lao-cai",
    name: "Lào Cai",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "Yên Bái + Lào Cai",
    title: "Học Bơi Lào Cai - Yên Bái: Lớp Học Bơi Uy Tín 1 Kèm 1",
    description: "Đăng ký học bơi Lào Cai và Yên Bái uy tín từ Swim For Life. Dạy bơi 1 kèm 1 cam kết bơi tốt đứng nước vững vàng ở chỗ sâu sâu.",
    headline: "Học Bơi Lào Cai - Yên Bái: Giáo Trình Bơi Sư Phạm Chuẩn",
    subtitle: "Dạy bơi chất lượng tại Lào Cai và Yên Bái. HLV tận tâm giàu nghiệp vụ sư phạm.",
    image: "/images/classes/lop-boi-tran-ngap-tieng-cuoi.jpg",
  ...
  {
    slug: "hoc-boi-tuyen-quang",
    name: "Tuyên Quang",
    region: "Miền Bắc",
    isTW: false,
    color: "aqua",
    mergedFrom: "Hà Giang + Tuyên Quang",
    title: "Học Bơi Tuyên Quang - Hà Giang: Khóa Dạy Bơi Uy Tín Cam Kết",
    description: "Đăng ký lớp học bơi tại Tuyên Quang và Hà Giang cùng Swim For Life Việt Nam. Dạy bơi 1 kèm 1 cam kết bơi tốt đứng nước tự tin vững vàng.",
    headline: "Học Bơi Tuyên Quang - Hà Giang: Lớp Học Bơi Sư Phạm Chuẩn",
    subtitle: "Lớp học bơi uy tín hàng đầu khu vực Tuyên Quang và Hà Giang. Cam kết bơi tốt đứng nước an toàn.",
    image: "/images/classes/lop-hoc-boi-vui-ve-ky-luat.jpg",
